...
import static com.qianqiu.ruiji_take_out.utils.SuccessConstant.SUCCESS_DELETE;
import static com.qianqiu.ruiji_take_out.utils.SuccessConstant.SUCCESS_UPDATE;
...
public class AddressBookController {
    ...
    public R<AddressBook> save(@RequestBody AddressBook addressBook) {
        addressBook.setUserId(Holder.getId());
    ...
    public R<AddressBook> setDefault(@RequestBody AddressBook addressBook) {
        ...
        wrapper.eq(AddressBook::getUserId, Holder.getId());
    ...
    @DeleteMapping
    public R<String> deleteAddressBook(String ids){
    ...
    public R<AddressBook> getDefault() {
        ...
        queryWrapper.eq(AddressBook::getUserId, Holder.getId());
